...
- [UNIVERSIDAD PERUANA DE CIENCIAS APLICADAS](#universidad-peruana-de-ciencias-aplicadas)
    ...
    - [Desarrollo de Aplicaciones Open Source - Presencial (1ASI0729)](#desarrollo-de-aplicaciones-open-source---presencial-1asi0729)
    - [Profesor: Hugo Allan Mori Paiva](#profesor-hugo-allan-mori-paiva)
    - [NRC: 7401](#nrc-7401)
  - [Informe - TB1](#informe---tb1)
  - [Startup: Prodevs](#startup-prodevs)
  - [Producto: DenunciaYa](#producto-denunciaya)
    - [INTEGRANTES](#integrantes)
    - [Ciclo 2025-20](#ciclo-2025-20)
- [Registro de versiones del informe](#registro-de-versiones-del-informe)
- [PROJECT REPORT COLLABORATION INSIGHTS](#project-report-collaboration-insights)
    - [2. Actividades de elaboracion del informe](#2-actividades-de-elaboracion-del-informe)
    - [3. Capturas en imagen de los analíticos de colaboración y commits en GitHub](#3-capturas-en-imagen-de-los-analíticos-de-colaboración-y-commits-en-github)
    - [4. Evidencia de participacion de todos los miembros del equipo |](#4-evidencia-de-participacion-de-todos-los-miembros-del-equipo-)
- [Contenido](#contenido)

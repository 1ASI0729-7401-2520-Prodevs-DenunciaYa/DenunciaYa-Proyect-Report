...
|---------------------|---------------------|---------------|
| **Comunica oralmente con efectividad a diferentes rangos de audiencia.** | **TB1 <br> Gabriel Braithwaite:** Lideró la comunicación inicial para el planeamiento estratégico del proyecto, alineando al equipo en los objetivos.<br>Validó la propuesta de valor del proyecto mediante una entrevista oral estructurada con un usuario clave del segmento objetivo.<br><br>**TP1:** Articuló verbalmente las complejidades del *bounded context* asignado, explicando con claridad las relaciones entre dominios para asegurar una comprensión integral y compartida dentro del equipo.<br><br>**TB1 <br> Gabriel Mamani:** Comunicó eficazmente su progreso y organizó su tiempo para cumplir con las responsabilidades asignadas, tanto en las historias de usuario como en el capítulo de diagramas C4, garantizando la sincronización con el equipo.<br><br>**TP1:** Expuso sus ideas con precisión durante la definición de un segmento del *bounded context*, facilitando la integración conceptual y la cohesión técnica del sistema.<br><br>**TB1 <br> Omar Rivera:** Coordinó y lideró oralmente la conceptualización del diseño de la *landing page*, asegurando que la propuesta visual reflejara los objetivos estratégicos del proyecto.<br>Transmitió de forma clara los lineamientos de la guía de estilos, permitiendo al equipo aplicarlos consistentemente en los *mockups* y *wireframes*.<br><br>**TP1:** Presentó verbalmente las relaciones clave de su dominio asignado en el *bounded context*, manteniendo la coherencia entre los distintos módulos del proyecto.<br><br>**TB1 <br> Franco Rioja:** Mantuvo una comunicación constante y proactiva con el equipo, funcionando como un nexo para asegurar el avance mutuo y la alineación continua en todas las tareas.<br><br>**TP1:** Comunicó verbalmente los alcances y limitaciones de su sección del *bounded context*, apoyando activamente la sincronización del equipo en la comprensión del dominio general.<br><br>**TB1 <br> Augusto Montes:** Dirigió entrevistas estratégicas con segmentos objetivos, estableciendo un diálogo claro y conciso para obtener *insights* valiosos sobre las necesidades del usuario, información que fue crucial para la definición de los requisitos del proyecto.<br><br>**TP1:** Presentó sus aportes de manera oral durante la definición de su componente del *bounded context*, garantizando la alineación de su trabajo con la arquitectura global y los objetivos del equipo. | **TB1:** La comunicación oral fue un pilar fundamental para el equipo, permitiendo una alineación estratégica y una ejecución cohesionada. A través de discusiones lideradas, entrevistas a usuarios y presentaciones técnicas, se logró un entendimiento profundo y compartido de los objetivos, requisitos y diseño del proyecto. La constante interacción verbal entre los miembros no solo facilitó la planificación y la resolución de problemas en tiempo real, sino que también fortaleció la sinergia del equipo, asegurando que el avance fuera colaborativo y que todos los integrantes estuvieran sincronizados en cada fase del desarrollo. |
| **Comunica por escrito con efectividad a diferentes rangos de audiencia.** | **TB1 <br> Gabriel Braithwaite:** Plasmó por escrito propuestas detalladas sobre puntos clave del proyecto, compartiéndolas con el equipo para su revisión y aprobación.<br>Documentó sistemáticamente sus contribuciones en el repositorio del reporte, asegurando la trazabilidad y el registro histórico del trabajo.<br><br>**TP1:** Elaboró una sección detallada del *bounded context*, describiendo con alta claridad y precisión las entidades y relaciones lógicas, dejando constancia formal en la documentación del proyecto.<br><br>**TB1 <br> Gabriel Mamani:** Lideró la documentación del proceso de *event storming*, traduciendo la sesión colaborativa en un artefacto escrito que sirvió como base para la definición de los requisitos y funcionalidades clave de la aplicación.<br><br>**TP1:** Detalló por escrito la lógica de negocio y los límites funcionales de su componente en el *bounded context*, creando una documentación esencial para la comprensión técnica del dominio por parte de otros miembros.<br><br>**TB1 <br> Omar Rivera:** Documentó y centralizó en el repositorio del proyecto las guías de estilo y la propuesta de diseño, creando una fuente única de verdad para facilitar su consulta y aplicación por parte del equipo.<br>Creó y registró formalmente los *mockups* y *wireframes* de la *landing page* y las aplicaciones web, comunicando de manera visual y escrita las decisiones fundamentales de la interfaz de usuario.<br><br>**TP1:** Redactó la descripción de su módulo dentro del *bounded context*, especificando sus responsabilidades y garantizando una documentación coherente e integrada con el resto del sistema.<br><br>**TB1 <br> Franco Rioja:** Sintetizó los hallazgos de las entrevistas en los artefactos escritos de *user persona*, documentó extensamente los apartados de *needfinding* y modeló el diagrama de clases, aportando claridad tanto al perfil del usuario como a la estructura técnica inicial.<br><br>**TP1:** Contribuyó a la documentación del *bounded context* detallando por escrito las entidades y relaciones principales del dominio que le fue asignado.<br><br>**TB1 <br> Augusto Montes:** Definió y documentó formalmente los segmentos objetivos finales del proyecto.<br>Redactó resúmenes ejecutivos del progreso del equipo al final de cada *sprint*, proporcionando una comunicación escrita, clara y concisa sobre los logros y avances.<br><br>**TP1:** Documentó su porción del *bounded context*, expresando de forma precisa en texto los límites, responsabilidades y objetivos de su componente dentro del modelo general del sistema. | **TB1:** La comunicación escrita fue crucial para formalizar el conocimiento y garantizar la consistencia a lo largo del proyecto. El equipo demostró una gran disciplina en la documentación de cada artefacto clave, desde los requisitos iniciales (*event storming*, *user personas*) hasta las especificaciones de diseño (*guías de estilo*, *mockups*) y la arquitectura del sistema (*bounded context*, diagramas de clases). Este enfoque no solo creó un registro auditable y detallado del trabajo realizado, sino que también minimizó ambigüedades, facilitó la integración de los componentes y aseguró que todos los miembros compartieran una comprensión precisa y unificada de la solución a desarrollar. |

...
|---------------------|---------------------|---------------|
| **Comunica oralmente con efectividad a diferentes rangos de audiencia.** | **TB1 <br> Gabriel Braithwaite:** Se comunicó con el equipo para el planeamiento del proyecto.<br>Comunicó la propuesta del proyecto hacia una persona de uno de los segmentos objetivos definidos mediante una entrevista oral.<br><br>**TP1:** Participó activamente en la elaboración de una parte del *bounded context*, explicando de manera clara las relaciones entre los distintos dominios y asegurando una comprensión compartida entre los miembros del equipo.<br><br>**TB1 <br> Gabriel Mamani:** Me comuniqué eficazmente y organicé mi tiempo para poder cumplir con mis responsabilidades tanto en las historias de usuario como en el capítulo de C4 diagrams.<br><br>**TP1:** Colaboró en la definición de un segmento del *bounded context*, exponiendo sus ideas con precisión para facilitar la integración conceptual dentro del sistema.<br><br>**TB1 <br> Omar Rivera:** Me comuniqué con mi equipo para coordinar y liderar la parte del diseño de la landing page, asegurando que la propuesta reflejara los objetivos del proyecto.<br>Expliqué de forma clara las ideas y lineamientos generales de estilo para que el equipo pudiera aplicarlos en el desarrollo de los mockups y wireframes de las aplicaciones web.<br><br>**TP1:** Desarrolló parte del *bounded context*, expresando de forma oral las relaciones clave del dominio para mantener coherencia entre los distintos módulos del proyecto.<br><br>**TB1 <br> Franco Rioja:** Contacté constantemente con el equipo para ayudar a que estemos en constante avance mutuo para estar todos alineados.<br><br>**TP1:** Contribuyó en la construcción del *bounded context*, comunicando verbalmente los alcances de su parte y apoyando la sincronización del equipo en la comprensión del dominio.<br><br>**TB1 <br> Augusto Montes:** Dirección de entrevista con los segmentos objetivos clave para el proyecto, estableciendo un diálogo claro y conciso para obtener información valiosa sobre las necesidades y expectativas de los usuarios; la comunicación fue crucial para la definición de los requisitos del proyecto.<br><br>**TP1:** Participó en la definición de un componente del *bounded context*, presentando sus aportes oralmente y garantizando la alineación de su trabajo con el resto del equipo. | **TB1:** El equipo demostró una comunicación efectiva y constante tanto interna como externa, lo que permitió mantener alineación en los objetivos y claridad en la transmisión de ideas; cada integrante organizó adecuadamente su tiempo y responsabilidades, aportando en áreas clave como las historias de usuario, los diagramas C4 y el diseño de la landing page, mientras que la coordinación y colaboración continua favorecieron el avance mutuo y el cumplimiento de los objetivos del proyecto. |
| **Comunica por escrito con efectividad a diferentes rangos de audiencia.** | **TB1 <br> Gabriel Braithwaite:** Comunicó las propuestas para diferentes puntos del proyecto de manera escrita para los miembros del equipo.<br>Los puntos realizados para el proyecto fueron documentados de manera escrita en el repositorio del reporte.<br><br>**TP1:** Redactó una sección del *bounded context*, describiendo con claridad las entidades y relaciones de su parte, dejando constancia escrita en la documentación del proyecto.<br><br>**TB1 <br> Gabriel Mamani:** Durante el desarrollo del proyecto, desempeñé un rol integral al liderar la creación del *event storming*, un proceso fundamental para establecer los requisitos y funcionalidades clave de nuestra aplicación.<br><br>**TP1:** Elaboró por escrito una parte del *bounded context*, detallando la lógica y los límites funcionales de su componente para facilitar la comprensión del dominio.<br><br>**TB1 <br> Omar Rivera:** Documenté las guías generales de estilo y la propuesta de diseño en el repositorio del proyecto para facilitar su aplicación por el equipo.<br>Desarrollé y dejé registrados los mockups y wireframes tanto de la landing page como de las web applications, asegurando consistencia visual y comunicando de manera escrita las decisiones clave de diseño.<br><br>**TP1:** Escribió la descripción de un módulo dentro del *bounded context*, especificando los aspectos más relevantes de su función dentro del sistema y garantizando una documentación coherente.<br><br>**TB1 <br> Franco Rioja:** Mi labor fue la realización de los *user persona* a partir de las entrevistas; a partir de eso completé la mayoría de apartados del *needfinding*, además hice una pequeña parte importante del capítulo 4 como por ejemplo el diagrama de clases.<br><br>**TP1:** Contribuyó por escrito en la definición de una parte del *bounded context*, detallando las entidades y relaciones principales del dominio que le correspondía.<br><br>**TB1 <br> Augusto Montes:** Determinación de los segmentos objetivos finales del proyecto. Redacción de resumen claro y conciso de los logros y el progreso del equipo durante el sprint.<br><br>**TP1:** Redactó una porción del *bounded context*, expresando de forma precisa los límites y objetivos de su componente dentro del modelo general. | **TB1:** En esta etapa del proyecto, el equipo se enfocó en la documentación y definición de requisitos, dejando un registro claro y organizado de los avances; Gabriel Braithwaite plasmó las propuestas y puntos desarrollados en el repositorio del reporte, mientras que Gabriel Mamani lideró la construcción del *event storming* para definir funcionalidades clave; Omar Rivera consolidó las guías de estilo, *mockups* y *wireframes* con documentación detallada que garantizó consistencia visual, y Franco Rioja aportó con la creación de *user persona*, el *needfinding* y diagramas de clases, fortaleciendo el entendimiento del usuario y la estructura técnica del sistema. |

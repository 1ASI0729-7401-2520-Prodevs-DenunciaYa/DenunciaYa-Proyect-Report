...
| US2             | Sección de segmentos objetivo     | Como visitante quiero ver a quién está dirigida la plataforma (ciudadanos y autoridades) para identificar si me corresponde usarla. | Scenario: Visualización de segmentos<br>Given que el visitante accede a la Landing Page<br>When la sección de segmentos está disponible<br>Then el visitante observa información diferenciada para ciudadanos y autoridades.           | EP1                       |
...
| US4             | Información de contacto y soporte | Como visitante quiero acceder a los datos de contacto y soporte para poder resolver dudas o reportar inconvenientes.                | Scenario: Visualización de contacto<br>Given que el visitante accede a la Landing Page<br>When se muestra la sección de soporte<br>Then el visitante observa un medio de contacto válido (ejemplo: correo institucional o formulario). | EP1                       |
| US5             | Sección “Sobre nosotros”          | Como visitante quiero conocer quiénes desarrollaron la plataforma y su propósito social para generar confianza y credibilidad.      | Scenario: Visualización de About Us<br>Given que el visitante accede a la Landing Page<br>When se muestra la sección “About Us”<br>Then el visitante observa información sobre el equipo y el propósito social de la aplicación.       | EP1                       |

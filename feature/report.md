...
|---------------------|---------------------|---------------|
| **Comunica oralmente con efectividad a diferentes rangos de audiencia.** | **Gabriel Braithuaite – TB1:** Lideró la comunicación inicial para el planeamiento estratégico del proyecto, alineando al equipo en los objetivos.<br>Validó la propuesta de valor mediante una entrevista oral estructurada con un usuario clave.<br><br>**Gabriel Braithuaite – TP1:** Articuló verbalmente las complejidades del *bounded context* asignado, explicando relaciones entre dominios para asegurar comprensión integral.<br><br>**Gabriel Braithuaite – TB2:** Comunicó de manera efectiva el avance y las decisiones técnicas del backend de **authorities**, coordinando validaciones y flujos con el equipo.<br><br>**Gabriel Mamani – TB1:** Comunicó eficazmente su progreso y organizó tiempos para cumplir sus responsabilidades en historias de usuario y diagramas C4.<br><br>**Gabriel Mamani – TP1:** Expuso sus ideas con precisión durante la definición de un segmento del *bounded context*, facilitando cohesión técnica del sistema.<br><br>**Gabriel Mamani – TB2:** Lideró verbalmente la coordinación del backend de **community**, explicando procesos del despliegue en Render.<br><br>**Omar Rivera – TB1:** Lideró oralmente la conceptualización del diseño de la *landing page*, asegurando consistencia con la guía de estilos.<br><br>**Omar Rivera – TP1:** Explicó verbalmente las relaciones clave de su dominio asignado en el *bounded context*.<br><br>**Omar Rivera – TB2:** Comunicó con claridad el funcionamiento del backend de **complaint**, explicando reglas de negocio y flujo de creación de denuncias.<br><br>**Franco Rioja – TB1:** Mantuvo comunicación constante y proactiva, asegurando alineación continua del equipo.<br><br>**Franco Rioja – TP1:** Comunicó los alcances y limitaciones de su parte del *bounded context*.<br><br>**Franco Rioja – TB2:** Expuso avances y decisiones técnicas del backend de **map**.<br><br>**Augusto Montes – TB1:** Dirigió entrevistas con segmentos objetivos, obteniendo *insights* clave mediante comunicación clara.<br><br>**Augusto Montes – TP1:** Presentó aportes sobre su componente del *bounded context*, garantizando alineación con la arquitectura global.<br><br>**Augusto Montes – TB2:** Lideró entrevistas adicionales con usuarios testigos para validar flujos y necesidades del sistema. | **TB1:** La comunicación oral fue fundamental para mantener la alineación estratégica del equipo. Las entrevistas, discusiones técnicas y presentaciones generaron una comprensión compartida del proyecto, facilitaron la coordinación y fortalecieron la sinergia grupal para resolver problemas y avanzar de manera cohesionada. |
| **Comunica por escrito con efectividad a diferentes rangos de audiencia.** | **Gabriel Braithuaite – TB1:** Redactó propuestas clave para el proyecto y documentó sistemáticamente sus aportes en el repositorio.<br><br>**Gabriel Braithuaite – TP1:** Elaboró una sección detallada del *bounded context* con entidades y relaciones bien descritas.<br><br>**Gabriel Braithuaite – TB2:** Documentó el backend de **authorities**, incluyendo endpoints, reglas de negocio y flujos.<br><br>**Gabriel Mamani – TB1:** Documentó el proceso de *event storming*, base para la definición de requisitos y funcionalidades.<br><br>**Gabriel Mamani – TP1:** Describió por escrito la lógica y límites funcionales de su parte del *bounded context*.<br><br>**Gabriel Mamani – TB2:** Documentó el backend de **community** y el proceso de despliegue en Render.<br><br>**Omar Rivera – TB1:** Documentó guías de estilo, *mockups* y *wireframes*, centralizando decisiones visuales.<br><br>**Omar Rivera – TP1:** Redactó la documentación de su módulo dentro del *bounded context*.<br><br>**Omar Rivera – TB2:** Documentó validaciones, estructura de endpoints y reglas del backend de **complaint**.<br><br>**Franco Rioja – TB1:** Documentó entrevistas, *user personas*, *needfinding* y el diagrama de clases.<br><br>**Franco Rioja – TP1:** Describió por escrito entidades y relaciones de su parte del *bounded context*.<br><br>**Franco Rioja – TB2:** Documentó el backend de **map**, detallando endpoints y retornos.<br><br>**Augusto Montes – TB1:** Documentó segmentos objetivos y redactó resúmenes ejecutivos del avance del equipo.<br><br>**Augusto Montes – TP1:** Documentó responsabilidades y límites de su módulo dentro del *bounded context*.<br><br>**Augusto Montes – TB2:** Documentó resultados de entrevistas del TB2, redactando conclusiones claras y estructuradas. | **TB1:** La comunicación escrita fue esencial para formalizar el conocimiento y garantizar coherencia durante todo el proyecto. La documentación disciplinada permitió minimizar ambigüedades, facilitar integración entre módulos y asegurar que todos compartieran una comprensión precisa del sistema en desarrollo. |

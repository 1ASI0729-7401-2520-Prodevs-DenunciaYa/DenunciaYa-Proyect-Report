...
|-----------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|
| Comunica oralmente con efectividad a diferentes rangos de audiencia.  | **TB1 - Gabriel Braithauite:** Se comunicó con el equipo para el planeamiento del proyecto. Comunicó la propuesta del proyecto hacia una persona de uno de los segmentos objetivos definidos mediante una entrevista oral.                             | TB1:         |
| Comunica por escrito con efectividad a diferentes rangos de audiencia | **TB1 - Gabriel Braithuaite:** Comunicó las propuestas para diferentes puntos del proyecto de manera escrita para los miembros del equipo. Los puntos realizados para el proyecto fueron documentados de manera escrita en el repositorio del reporte. | TB1:         |

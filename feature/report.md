...
| 1.1     | 08/09/2025 | Braithuaite Toledo, Gabriel Anthony  | Elaboración de las User Stories del Landing Page.                                                                                                                                                                                           |
| 1.2     | 11/09/2025 | Mamani Marca, Gabriel Cristian     | Desarrollo del análisis competitivo.                                                                                                                                                                                                       |
| 1.3     | 14/09/2025 | Braithuaite Toledo, Gabriel Anthony  | Desarrollo de las User Stories para la aplicación web.                                                                                                                                                                                      |
...
| 1.6     | 15/09/2025 | Braithuaite Toledo, Gabriel Anthony  | Elaboración del Product Backlog y actualización de las User Stories.                                                                                                                                                                        |
| 1.7     | 18/09/2025 | Braithuaite Toledo, Gabriel Anthony  | Corrección de las User Stories de la aplicación web.                                                                                                                                                                                        |
...
| 2.2     | 20/09/2025 | Braithuaite Toledo, Gabriel Anthony  | Elaboración del diagrama de clases.                                                                                                                                                                                                         |
...
- [UNIVERSIDAD PERUANA DE CIENCIAS APLICADAS](#universidad-peruana-de-ciencias-aplicadas)
    ...
    - [Periodo: 202520](#periodo-202520)
    - [Nombre del curso: Desarrollo de Aplicaciones Open Source - Presencial](#nombre-del-curso-desarrollo-de-aplicaciones-open-source---presencial)
    - [NRC: 7401](#nrc-7401)
    - [Nombre del profesor: Hugo Allan Mori Paiva](#nombre-del-profesor-hugo-allan-mori-paiva)
  - [Informe de Trabajo Final](#informe-de-trabajo-final)
  - [Nombre del startup: Prodevs](#nombre-del-startup-prodevs)
  - [Nombre del producto: DenunciaYa](#nombre-del-producto-denunciaya)
    - [Relación de integrantes:](#relación-de-integrantes)
    - [Diciembre,2025](#diciembre2025)
- [Registro de versiones del informe](#registro-de-versiones-del-informe)
- [PROJECT REPORT COLLABORATION INSIGHTS](#project-report-collaboration-insights)
      - [Repositorio del informe del proyecto](#repositorio-del-informe-del-proyecto)
...
- [Capítulo II: Requirements Elicitation \& Analysis](#capítulo-ii-requirements-elicitation--analysis)
  ...
  - [2.2. Entrevistas.](#22-entrevistas)
    - [2.2.1. Diseño de entrevistas.](#221-diseño-de-entrevistas)
      - [Preguntas para el segmento objetivo "Ciudadanos"](#preguntas-para-el-segmento-objetivo-ciudadanos)
      - [Preguntas para el segmento objetivo  "Autoridades Municipales y Gubernamentales"](#preguntas-para-el-segmento-objetivo--autoridades-municipales-y-gubernamentales)
    - [2.2.2. Registro de entrevistas.](#222-registro-de-entrevistas)
  - [Segmento: Ciudadanos](#segmento-ciudadanos)
    - [Entrevista 1 – Luis Fernández](#entrevista-1--luis-fernández)
    - [Entrevista 2 –  Stephano Moscoso](#entrevista-2---stephano-moscoso)
    - [Entrevista 3 – George Garcia Durand](#entrevista-3--george-garcia-durand)
  - [Segmento: Autoridades](#segmento-autoridades)
    - [Entrevista 1 – Carolina Méndez](#entrevista-1--carolina-méndez)
    - [Entrevista 2 – Jorge Torres](#entrevista-2--jorge-torres)
    - [Entrevista 3 – Juan José](#entrevista-3--juan-josé)
    - [2.2.3. Análisis de entrevistas.](#223-análisis-de-entrevistas)
      - [Segmento: Ciudadanos](#segmento-ciudadanos-1)
      - [Segmento: Autoridades](#segmento-autoridades-1)
    - [2.2.3. Análisis de entrevistas.](#223-análisis-de-entrevistas-1)
  - [2.3. Needfinding.](#23-needfinding)
    - [2.3.1. User Personas.](#231-user-personas)
  - [User Persona - Ciudadano](#user-persona---ciudadano)
  - [User Persona - Autoridad](#user-persona---autoridad)
    - [2.3.2. User Task Matrix.](#232-user-task-matrix)
  - [Task Matrix - Ciudadano](#task-matrix---ciudadano)
  - [Task Matrix - Autoridad](#task-matrix---autoridad)
    - [2.3.3. User Journey Mapping.](#233-user-journey-mapping)
  - [Journey Map - Ciudadano](#journey-map---ciudadano)
  - [Journey Map - Autoridad](#journey-map---autoridad)
    - [2.3.4. Empathy Mapping.](#234-empathy-mapping)
  - [Empathy map - Ciudadano](#empathy-map---ciudadano)
  - [Empathy map - Autoridad](#empathy-map---autoridad)
  - [2.4. Big Picture Event Storming.](#24-big-picture-event-storming)
  - [2.5. Ubiquitous Language.](#25-ubiquitous-language)
  - [Actores / Roles](#actores--roles)
  - [Conceptos Clave (Landing Page)](#conceptos-clave-landing-page)
  - [Denuncias](#denuncias)
  - [Gestión de Denuncias](#gestión-de-denuncias)
  - [Dashboard de Autoridades](#dashboard-de-autoridades)
  - [Historial de Intervenciones](#historial-de-intervenciones)
  - [Autenticación y Gestión de Cuentas](#autenticación-y-gestión-de-cuentas)
  - [Comunidad](#comunidad)
...
- [Capítulo IV: Product Design](#capítulo-iv-product-design)
  - [4.1. Style Guidelines.](#41-style-guidelines)
    - [4.1.1. General Style Guidelines.](#411-general-style-guidelines)
      ...
      - [Colors](#colors)
      - [Spacing](#spacing)
      - [Tone of Voice and Communication](#tone-of-voice-and-communication)
    - [4.1.2. Web Style Guidelines.](#412-web-style-guidelines)
      - [Layout y Grid System](#layout-y-grid-system)
      - [Responsive Design](#responsive-design)
      - [Componentes UI](#componentes-ui)
  - [](#)
      - [Interacciones y Estados](#interacciones-y-estados)
      - [Navegación](#navegación)
      - [Accesibilidad](#accesibilidad)
  - [4.2. Information Architecture](#42-information-architecture)
    - [4.2.1. Organization Systems](#421-organization-systems)
      - [Aplicación por grupos de información](#aplicación-por-grupos-de-información)
      - [Esquemas de categorización aplicados (resumen)](#esquemas-de-categorización-aplicados-resumen)
    - [4.2.2. Labeling Systems](#422-labeling-systems)
      - [Reglas generales de etiquetado](#reglas-generales-de-etiquetado)
      - [Etiquetas primarias (menú y CTAs)](#etiquetas-primarias-menú-y-ctas)
    - [Etiquetas internas y de formularios](#etiquetas-internas-y-de-formularios)
      - [Microcopy / mensajes y estados](#microcopy--mensajes-y-estados)
    - [4.2.3. SEO Tags and Meta Tags](#423-seo-tags-and-meta-tags)
    - [Reglas SEO generales](#reglas-seo-generales)
      - [Ejemplos de tags](#ejemplos-de-tags)
    - [4.2.4. Searching Systems](#424-searching-systems)
      - [Ubicación e interacción principal](#ubicación-e-interacción-principal)
      - [Capacidades de búsqueda](#capacidades-de-búsqueda)
    - [4.2.5. Navigation Systems](#425-navigation-systems)
      - [Patrón de navegación global](#patrón-de-navegación-global)
      - [Flujos de navegación clave](#flujos-de-navegación-clave)
      - [Buenas prácticas de navegación](#buenas-prácticas-de-navegación)
  ...
  - [2. Pantalla de Register](#2-pantalla-de-register)
  - [3. Pantalla de Payment Card](#3-pantalla-de-payment-card)
  - [4. Pantalla de Mis Denuncias](#4-pantalla-de-mis-denuncias)
  - [5. Pantalla de Denunciar Ahora](#5-pantalla-de-denunciar-ahora)
  - [6. Pantalla de Detalles de la Denuncia](#6-pantalla-de-detalles-de-la-denuncia)
  - [7. Pantalla de Community](#7-pantalla-de-community)
  - [8. Pantalla de Editar Denuncia](#8-pantalla-de-editar-denuncia)
  - [9. Pantalla de Agregar Responsable](#9-pantalla-de-agregar-responsable)
  - [10. Pantalla de Inicio](#10-pantalla-de-inicio)
  - [11. Pantalla de Detalles de Equipo](#11-pantalla-de-detalles-de-equipo)
    - [4.4.2. Web Applications Wireflow Diagrams.](#442-web-applications-wireflow-diagrams)
    - [User goal: Creación de quejas](#user-goal-creación-de-quejas)
      - [Happy path:](#happy-path)
      - [Unhappy path:](#unhappy-path)
    - [User goal: Directorio de recursos y contactos](#user-goal-directorio-de-recursos-y-contactos)
    - [User goal: Historial de seguimiento de quejas](#user-goal-historial-de-seguimiento-de-quejas)
    - [User goal: Panel de autoridades](#user-goal-panel-de-autoridades)
      - [Happy path:](#happy-path-1)
      - [Unhappy path:](#unhappy-path-1)
    - [User goal: Authentication y gestión de cuentas](#user-goal-authentication-y-gestión-de-cuentas)
      - [Happy path:](#happy-path-2)
      - [Unhappy path:](#unhappy-path-2)
    - [User goal: Comunidad](#user-goal-comunidad)
    - [4.4.3. Web Applications Mock-ups.](#443-web-applications-mock-ups)
  - [Pantalla de Login](#pantalla-de-login)
  - [Pantalla de Register](#pantalla-de-register)
  - [3. Pantalla de Payment Card](#3-pantalla-de-payment-card-1)
  - [4. Pantalla de Mis Denuncias](#4-pantalla-de-mis-denuncias-1)
  - [5. Pantalla de Denunciar Ahora](#5-pantalla-de-denunciar-ahora-1)
  - [6. Pantalla de Detalles de la Denuncia](#6-pantalla-de-detalles-de-la-denuncia-1)
  - [7. Pantalla de Community](#7-pantalla-de-community-1)
  - [8. Pantalla de Editar Denuncia](#8-pantalla-de-editar-denuncia-1)
  - [9. Pantalla de Agregar Responsable](#9-pantalla-de-agregar-responsable-1)
  - [10. Pantalla de Inicio](#10-pantalla-de-inicio-1)
  - [11. Pantalla de Detalles de Equipo](#11-pantalla-de-detalles-de-equipo-1)
    - [4.4.4. Web Applications User Flow Diagrams](#444-web-applications-user-flow-diagrams)
    - [User goal: Creación de quejas](#user-goal-creación-de-quejas-1)
      - [Happy path:](#happy-path-3)
      - [Unhappy path:](#unhappy-path-3)
    - [User goal: Directorio de recursos y contactos](#user-goal-directorio-de-recursos-y-contactos-1)
    - [User goal: Historial de seguimiento de quejas](#user-goal-historial-de-seguimiento-de-quejas-1)
    - [User goal: Panel de autoridades](#user-goal-panel-de-autoridades-1)
      - [Happy path:](#happy-path-4)
      - [Unhappy path:](#unhappy-path-4)
    - [User goal: Authentication y gestión de cuentas](#user-goal-authentication-y-gestión-de-cuentas-1)
      - [Happy path:](#happy-path-5)
      - [Unhappy path:](#unhappy-path-5)
    - [User goal: Comunidad](#user-goal-comunidad-1)
  - [4.5. Web Applications Prototyping.](#45-web-applications-prototyping)
      - [Exposicion del prototipo](#exposicion-del-prototipo)
...
- [5.2.3.5. Execution Evidence for Sprint Review](#5235-execution-evidence-for-sprint-review)
      ...
      - [Evidencia](#evidencia)
      - [Enlace del despliegue](#enlace-del-despliegue)
...
- [5.2.3.7.Software Deployment Evidence for Sprint Review.](#5237software-deployment-evidence-for-sprint-review)
      - [El frontend se desplego usando la herramienta de versel](#el-frontend-se-desplego-usando-la-herramienta-de-versel)
      - [Backend Web Service](#backend-web-service)
    - [Pasos para el despligue](#pasos-para-el-despligue)
...
- [5.2.4.5. Execution Evidence for Sprint Review](#5245-execution-evidence-for-sprint-review)
      - [Objetivos alcanzados:](#objetivos-alcanzados-1)
      - [Evidencia](#evidencia-1)
      - [Enlace del despliegue](#enlace-del-despliegue-1)
...
- [5.2.4.7.Software Deployment Evidence for Sprint Review.](#5247software-deployment-evidence-for-sprint-review)
    - [El frontend deployment](#el-frontend-deployment)
    - [I. Requisitos Previos](#i-requisitos-previos)
    - [II. Generación del Build de Producción:](#ii-generación-del-build-de-producción)
    - [III. Inicialización de Firebase Hosting y CI/CD](#iii-inicialización-de-firebase-hosting-y-cicd)
    - [IV. Activación del Despliegue Continuo (CI/CD):](#iv-activación-del-despliegue-continuo-cicd)
    - [V. Verificación Final](#v-verificación-final)
    - [Backend Web Service Deployment](#backend-web-service-deployment)
    - [Pasos para el despliegue](#pasos-para-el-despliegue)
    - [I. Preparación del código y archivos](#i-preparación-del-código-y-archivos)
    - [II. Configuración de la Base de Datos (DB)](#ii-configuración-de-la-base-de-datos-db)
    - [III. Despliegue en Render](#iii-despliegue-en-render)
  - [5.2.4.8. Team Collaboration Insights during Sprint](#5248-team-collaboration-insights-during-sprint)
    - [Frontend](#frontend-1)
    - [Backend](#backend-1)
    - [5.3.Validation Interviews](#53validation-interviews)
    - [5.3.1. Diseño de Entrevistas](#531-diseño-de-entrevistas)
    - [Segmento #1: Ciudadanos](#segmento-1-ciudadanos)
    - [Segmento #2: Autoridades Municipales](#segmento-2-autoridades-municipales)
  - [5.3.2. Registro de Entrevistas](#532-registro-de-entrevistas)
    - [Segmento: Ciudadanos](#segmento-ciudadanos-2)
    - [Segmento: Autoridades Municipales](#segmento-autoridades-municipales)
...
- [Conclusiones](#conclusiones)
    - [1. Integración completa y funcional del sistema](#1-integración-completa-y-funcional-del-sistema)
    - [2. Seguridad y gestión de identidad robusta](#2-seguridad-y-gestión-de-identidad-robusta)
    - [3. Automatización y despliegue en entornos productivos](#3-automatización-y-despliegue-en-entornos-productivos)
    - [4. Cobertura funcional integral y social](#4-cobertura-funcional-integral-y-social)
    - [5. Solidez de la arquitectura de software](#5-solidez-de-la-arquitectura-de-software)
...
|---------------------|---------------------|---------------|
| **Comunica oralmente con efectividad a diferentes rangos de audiencia.** | **Gabriel Braithuaite – TB1:** Lideró la comunicación inicial para el planeamiento estratégico del proyecto, alineando al equipo en los objetivos.<br>Validó la propuesta de valor mediante una entrevista oral estructurada con un usuario clave.<br><br>**Gabriel Braithuaite – TP1:** Articuló verbalmente las complejidades del *bounded context* asignado, explicando relaciones entre dominios para asegurar comprensión integral.<br><br>**Gabriel Braithuaite – TB2:** Comunicó de manera efectiva el avance y las decisiones técnicas del backend de **authorities**, coordinando validaciones y flujos con el equipo.<br><br>**Gabriel Braithuaite – TF:** Comunicó los resultados del Sprint 4, explicando el proceso de *deploy* del frontend y la implementación full stack del módulo de Responsibles.<br><br>**Gabriel Mamani – TB1:** Comunicó eficazmente su progreso y organizó tiempos para cumplir sus responsabilidades en historias de usuario y diagramas C4.<br><br>**Gabriel Mamani – TP1:** Expuso sus ideas con precisión durante la definición de un segmento del *bounded context*, facilitando cohesión técnica del sistema.<br><br>**Gabriel Mamani – TB2:** Lideró verbalmente la coordinación del backend de **community**, explicando procesos del despliegue en Render.<br><br>**Gabriel Mamani – TF:** Coordinó el despliegue final del backend y explicó la integración técnica (conexión front-back) en el contexto de Community y el módulo IAM.<br><br>**Omar Rivera – TB1:** Lideró oralmente la conceptualización del diseño de la *landing page*, asegurando consistencia con la guía de estilos.<br><br>**Omar Rivera – TP1:** Explicó verbalmente las relaciones clave de su dominio asignado en el *bounded context*.<br><br>**Omar Rivera – TB2:** Comunicó con claridad el funcionamiento del backend de **complaint**, explicando reglas de negocio y flujo de creación de denuncias.<br><br>**Omar Rivera – TF:** Expuso la lógica de conexión entre frontend y backend para *Complaint Creation* y *Authorities Panel*, además de discutir las correcciones del reporte final.<br><br>**Franco Rioja – TB1:** Mantuvo comunicación constante y proactiva, asegurando alineación continua del equipo.<br><br>**Franco Rioja – TP1:** Comunicó los alcances y limitaciones de su parte del *bounded context*.<br><br>**Franco Rioja – TB2:** Expuso avances y decisiones técnicas del backend de **map**.<br><br>**Franco Rioja – TF:** Presentó el desarrollo integral (*back y front*) de las funcionalidades de Mapas, Responsibles y Complaints, asegurando la coherencia funcional.<br><br>**Augusto Montes – TB1:** Dirigió entrevistas con segmentos objetivos, obteniendo *insights* clave mediante comunicación clara.<br><br>**Augusto Montes – TP1:** Presentó aportes sobre su componente del *bounded context*, garantizando alineación con la arquitectura global.<br><br>**Augusto Montes – TB2:** Lideró entrevistas adicionales con usuarios testigos para validar flujos y necesidades del sistema.<br><br>**Augusto Montes – TF:** Explicó y justificó las correcciones de diseño aplicadas al Login para mejorar la experiencia de usuario.<br><br>**Luis Montañez – TF:** Presentó el registro de versiones y los hallazgos del análisis Lean UX y evaluaciones heurísticas, justificando los cambios en la *landing page*. | **Gabriel Braithuaite**<br>**TB1:** Liderar la comunicación estratégica y las entrevistas me permitió alinear al equipo desde el inicio hacia un objetivo común.<br>**TP1:** Al articular las relaciones del *bounded context*, logré clarificar la arquitectura del dominio para todo el equipo.<br>**TB2:** La coordinación oral sobre el backend de *authorities* fue vital para asegurar los flujos de seguridad del sistema.<br>**TF:** Explicar el despliegue y el módulo *Full Stack* demostró mi capacidad para comunicar procesos técnicos complejos.<br><br>**Gabriel Mamani**<br>**TB1:** Comunicar mi progreso en los diagramas C4 ayudó a mantener la organización temporal del grupo.<br>**TP1:** Mi exposición sobre el segmento del *bounded context* facilitó la cohesión técnica necesaria en esa etapa.<br>**TB2:** Explicar el despliegue en Render fue clave para que el equipo entendiera la infraestructura del backend.<br>**TF:** Coordinar verbalmente la integración final del IAM y Community aseguró un cierre de proyecto sin fricciones.<br><br>**Omar Rivera**<br>**TB1:** Conceptualizar verbalmente el diseño de la *landing* aseguró que todos compartiéramos la misma visión estética.<br>**TP1:** Explicar las relaciones de mi dominio permitió integrar eficazmente mi módulo con el resto.<br>**TB2:** Comunicar las reglas de negocio de *complaints* garantizó que el flujo de denuncias fuera comprendido por todos.<br>**TF:** Exponer la lógica de conexión entre capas validó el funcionamiento final de los paneles administrativos.<br><br>**Franco Rioja**<br>**TB1:** Mantener una comunicación proactiva fue esencial para evitar bloqueos en las etapas iniciales.<br>**TP1:** Comunicar los límites de mi contexto ayudó a definir claramente las responsabilidades del sistema.<br>**TB2:** Exponer las decisiones técnicas sobre el mapa permitió recibir feedback valioso para el desarrollo.<br>**TF:** Presentar el desarrollo integral de mis módulos demostró la coherencia funcional alcanzada en el producto final.<br><br>**Augusto Montes**<br>**TB1:** Dirigir las entrevistas me permitió extraer *insights* que fundamentaron nuestras decisiones de diseño.<br>**TP1:** Presentar mis aportes arquitectónicos aseguró que mi componente se alineara con la visión global.<br>**TB2:** Las entrevistas de validación que lideré confirmaron que íbamos por el camino correcto con los usuarios.<br>**TF:** Justificar oralmente los cambios en el Login fue clave para mejorar la usabilidad del producto final.<br><br>**Luis Montañez**<br>**TF:** Presentar las heurísticas y el historial de versiones brindó al equipo la seguridad de entregar un producto validado y profesional. |
| **Comunica por escrito con efectividad a diferentes rangos de audiencia.** | **Gabriel Braithuaite – TB1:** Redactó propuestas clave para el proyecto y documentó sistemáticamente sus aportes en el repositorio.<br><br>**Gabriel Braithuaite – TP1:** Elaboró una sección detallada del *bounded context* con entidades y relaciones bien descritas.<br><br>**Gabriel Braithuaite – TB2:** Documentó el backend de **authorities**, incluyendo endpoints, reglas de negocio y flujos.<br><br>**Gabriel Braithuaite – TF:** Documentó el procedimiento de despliegue del frontend y detalló la estructura de código del módulo de Responsibles.<br><br>**Gabriel Mamani – TB1:** Documentó el proceso de *event storming*, base para la definición de requisitos y funcionalidades.<br><br>**Gabriel Mamani – TP1:** Describió por escrito la lógica y límites funcionales de su parte del *bounded context*.<br><br>**Gabriel Mamani – TB2:** Documentó el backend de **community** y el proceso de despliegue en Render.<br><br>**Gabriel Mamani – TF:** Redactó la documentación técnica del despliegue del backend y detalló los componentes desarrollados para el IAM y Community.<br><br>**Omar Rivera – TB1:** Documentó guías de estilo, *mockups* y *wireframes*, centralizando decisiones visuales.<br><br>**Omar Rivera – TP1:** Redactó la documentación de su módulo dentro del *bounded context*.<br><br>**Omar Rivera – TB2:** Documentó validaciones, estructura de endpoints y reglas del backend de **complaint**.<br><br>**Omar Rivera – TF:** Documentó la integración de servicios de *Complaint Creation* y *Authorities Panel*, y realizó las correcciones escritas en el reporte.<br><br>**Franco Rioja – TB1:** Documentó entrevistas, *user personas*, *needfinding* y el diagrama de clases.<br><br>**Franco Rioja – TP1:** Describió por escrito entidades y relaciones de su parte del *bounded context*.<br><br>**Franco Rioja – TB2:** Documentó el backend de **map**, detallando endpoints y retornos.<br><br>**Franco Rioja – TF:** Documentó el desarrollo técnico de los módulos de Mapas, Responsibles y Complaints, especificando su funcionamiento en ambas capas.<br><br>**Augusto Montes – TB1:** Documentó segmentos objetivos y redactó resúmenes ejecutivos del avance del equipo.<br><br>**Augusto Montes – TP1:** Documentó responsabilidades y límites de su módulo dentro del *bounded context*.<br><br>**Augusto Montes – TB2:** Documentó resultados de entrevistas del TB2, redactando conclusiones claras y estructuradas.<br><br>**Augusto Montes – TF:** Documentó las iteraciones y correcciones finales en el diseño visual del Login.<br><br>**Luis Montañez – TF:** Elaboró el registro histórico de versiones, redactó el informe de Lean UX y evaluaciones heurísticas, y actualizó los recursos gráficos de la *landing page*. | **Gabriel Braithuaite**<br>**TB1:** Redactar las propuestas clave formalizó el rumbo del proyecto y dejó constancia de nuestros objetivos.<br>**TP1:** Detallar las entidades por escrito aseguró una base sólida para la implementación del código.<br>**TB2:** Documentar el backend de *authorities* facilitó la comprensión de las reglas de negocio implementadas.<br>**TF:** La documentación del despliegue del frontend sirve como una guía técnica indispensable para el mantenimiento futuro.<br><br>**Gabriel Mamani**<br>**TB1:** Documentar el *Event Storming* fue fundamental para tener claros los requisitos desde el principio.<br>**TP1:** Describir la lógica de mi contexto evitó ambigüedades durante el desarrollo.<br>**TB2:** Registrar el proceso de despliegue en Render permite que cualquier miembro pueda replicar la infraestructura.<br>**TF:** La redacción técnica sobre el IAM y Community evidencia la robustez de la arquitectura construida.<br><br>**Omar Rivera**<br>**TB1:** Documentar los *mockups* y guías de estilo centralizó las decisiones visuales, evitando inconsistencias.<br>**TP1:** La redacción de mi módulo permitió una integración fluida con los otros componentes del sistema.<br>**TB2:** Documentar las validaciones de *complaints* aseguró la calidad y seguridad de los datos ingresados.<br>**TF:** Al documentar las integraciones y correcciones, garanticé la entrega de un reporte final pulido y profesional.<br><br>**Franco Rioja**<br>**TB1:** El registro escrito del *needfinding* y *User Personas* mantuvo al usuario en el centro de nuestras decisiones.<br>**TP1:** Describir las relaciones de mi contexto facilitó la comunicación técnica con el resto del equipo.<br>**TB2:** Documentar los endpoints del mapa fue crucial para que el frontend pudiera consumirlos correctamente.<br>**TF:** Documentar el funcionamiento *Full Stack* de mis módulos valida la complejidad técnica superada en el proyecto.<br><br>**Augusto Montes**<br>**TB1:** Los resúmenes ejecutivos que redacté mantuvieron al equipo enfocado en los hitos importantes.<br>**TP1:** Documentar los límites de mi módulo ayudó a mantener una arquitectura limpia y ordenada.<br>**TB2:** Las conclusiones escritas de las entrevistas validaron objetivamente el rumbo del desarrollo.<br>**TF:** Documentar las mejoras del Login deja constancia de cómo el diseño evolucionó para satisfacer al usuario.<br><br>**Luis Montañez**<br>**TF:** Elaborar el informe de Lean UX y el registro de versiones aportó la trazabilidad y sustento metodológico necesario para el cierre del proyecto. |
...
| ![Luis_montanez.jpg](../assets/Luis_montanez.jpg)  |   Luis Angel Montañez Moreno   | u202223811       | Ingenieria de software | Soy un estudiante de sexto ciclo de la carrera de Ingeniería de Software que le gusta aprender sobre la tecnología y cómo su uso puede mejorar nuestra vida cotidiana. Mi objetivo es seguir adquiriendo conocimientos en lenguajes de programación para ser más competente en el mundo profesional. |
...
**Link del figma:** https://www.figma.com/proto/OSRDXwebVTO7alXvVswuVC/Untitled?node-id=1-2&t=BA3eZDY6GQFIsHNe-1&starting-point-node-id=1%3A2
...
## 1. Pantalla de Login  
**Wireframe Deskopt**  
![Wireframe Login Deskopt](/assets/WireframeLogin.jpg)  
**Wireframe Mobile**  
![Wireframe Login Mobile](/assets/wireframemobilelogin.png)  
...
**Wireframe Deskopt**  
![Wireframe Register Deskopt](/assets/WireframeRegister.jpg)  
**Wireframe Mobile**  
![Wireframe Register Mobile](/assets/wireframemobileregister.png)  
**Explicación**  
...
**Wireframe Mobile**  
![Wireframe Payment Mobile](/assets/wireframemobilpayment.png)  
**Explicación**  
...
**Wireframe**  
![Wireframe MisDenuncias Deskopt](/assets/WireframeMisDenuncias.jpg)  
**Wireframe Mobile**  
![Wireframe Payment Mobile](/assets/wireframemobilmisdenuncias.png)  
**Explicación**  
...
**Wireframe**  
![Wireframe DenunciarAhora Deskopt](/assets/WireframeDenunciarAhora.jpg)  
**Wireframe Mobile**  
![Wireframe DenunciarAhora Mobile](/assets/wireframemobildenunciarahora.png)  
**Explicación**  
...
**Wireframe**  
![Wireframe DetallesDenuncia Deskopt](/assets/WireframeDetalleDenuncia.jpg)  
**Wireframe Mobile**  
![Wireframe DetalleDenuncias Mobile](/assets/wireframemobildetalledenuncia.png) 
**Explicación**  
...
**Wireframe**  
![Wireframe Comunity Deskopt](/assets/WireframeComunity.png)  
**Wireframe Mobile**  
![Wireframe Community Mobile](/assets/WireframeMobileCommunity.png) 
**Explicación**  
...
**Wireframe**  
![Wireframe EditarDenuncia Deskopt](/assets/WireframeEditarD.jpg)  
**Wireframe Mobile**  
![Wireframe Editar Denuncia Mobile](/assets/WireframeMobilEditar.png) 
**Explicación**  
...
**Wireframe**  
![Wireframe Nuevo Responsable Deskopt](/assets/WireframeNuevoResponsable.jpg)  
**Wireframe Mobile**  
![Wireframe Nuevo Responsable Mobile](/assets/wireframemobileresponsable.png) 
**Explicación**  
...
**Wireframe**  
![Wireframe Login Deskopt](/assets/WireframePantallaGraficos.jpg)  
**Wireframe Mobile**  
![Wireframe Login Mobile](/assets/wireframemobilbienvenido.png) 
**Explicación**  
...
**Wireframe**  
![Wireframe GestionDeEquipos Deskopt](/assets/WireframeGestionEquipo.jpg)  
**Wireframe Mobile**  
![Wireframe GestionDeEquipos Mobile](/assets/wireframemobilgestion.png) 
**Explicación**  
...
##  Pantalla de Login  
**Mock-up**  
![MockUp Login Desktop](/assets/Login.jpg)
**Mock-up Mobile**  
![MockUp Login Mobile](/assets/MockUpLogin.png) 
**Explicación**  
- **Principios de diseño:** Jerarquía visual clara con logo en la parte superior, formulario centrado y botón principal destacado.  
- **Elementos de diseño:** Colores claros y precisos, tipografía consistente y botones con esquinas redondeadas para mayor accesibilidad.  
- **Diseño inclusivo:** Contraste suficiente entre texto y fondo, etiquetas visibles en los campos, soporte para teclado.  
...
**Mock-up**  
![MockUp Register Desktop](/assets/Register.jpg)
**Mock-up Mobile**  
![MockUp Login Mobile](/assets/MockUpRegister.png) 
**Explicación**  
- **Principios de diseño:** Uso de agrupación por proximidad para los campos.  
- **Elementos de diseño:** Campos con iconos de apoyo, botón destacado al final del formulario.  
- **Diseño inclusivo:** Labels claros, mensajes de error accesibles y compatibilidad con lector de pantalla.  
...
## 3. Pantalla de Payment Card  
**Mock-up**  
![MockUp Payment Desktop](/assets/Payment.jpg)
**Mock-up Mobile**  
![MockUp Payment Mobile](/assets/MockUpPayment.png) 
**Explicación**  
- **Principios de diseño:** Contraste entre datos de la tarjeta y el fondo, buena alineación.  
- **Diseño inclusivo:** Tamaño de campos adecuado, validación visual clara de errores.  
- **Arquitectura de información:** Flujo secuencial: datos de tarjeta → confirmación → confirmar el pago.  
...
## 4. Pantalla de Mis Denuncias 
**Mock-up**  
![MockUp MisDenuncias Desktop](/assets/MisDenuncias.jpg)
**Mock-up Mobile**  
![MockUp MisDenuncias Mobile](/assets/MockUpMisDenuncias1.png) 
![MockUp MisDenuncias Mobile](/assets/MockUpMisDenuncias2.png) 
**Explicación**  
...
## 5. Pantalla de Denunciar Ahora   
**Mock-up**  
![MockUp DenunciarAhora Desktop](/assets/DenunciarAhora.png)
**Mock-up Mobile**  
![MockUp DenunciarAhora Mobile](/assets/DenunciarAhoraMobile.png) 
**Explicación**  
- **Principios de diseño:** Agrupación por secciones: datos básicos, descripción, adjuntos.  
- **Elementos de diseño:** Botón de adjuntar archivos, área de texto amplia.  
- **Diseño inclusivo:** Instrucciones claras, ayudas contextuales, validación accesible.  
...
## 6. Pantalla de Detalles de la Denuncia
**Mock-up**  
![MockUp Detalle Denuncia Desktop](/assets/DetallesDenunciaAutoridad.jpg)
**Mock-up Mobile**  
![MockUp Detalle Denuncia Mobile](/assets/Detalles%20de%20Denuncia.png) 
**Explicación**  
- **Principios de diseño:** Línea de tiempo horizontal con estados en orden cronológico.  
- **Elementos de diseño:** Íconos de estado, colores diferenciados.  
- **Diseño inclusivo:** Texto acompañando a cada ícono para claridad.  
...
## 7. Pantalla de Community   
**Mock-up**  
![MockUp Community Desktop](/assets/Comunity.jpg)
**Mock-up Mobile**  
![MockUp Community Mobile](/assets/WireframeMobileCommunity.png) 
**Explicación**  
- **Principios de diseño:** Uso de tarjetas para cada post, jerarquía clara entre usuario, texto e interacciones.  
- **Elementos de diseño:** Íconos reconocibles (me gusta, comentar, compartir).  
- **Diseño inclusivo:** Texto alternativo para imágenes, interacciones accesibles vía teclado.  
...
## 8. Pantalla de Editar Denuncia  
**Mock-up**  
![MockUp Editar Denuncia Desktop](/assets/EditarDenuncia.jpg)
**Mock-up Mobile**  
![MockUp Editar Denuncia Mobile](/assets/MockUpCommunity.png) 
...
## 9. Pantalla de Agregar Responsable 
**Mock-up**  
![MockUp AgregarResponsable Desktop ](/assets/AsignarResponsable.png)
  **Mock-up Mobile**  
![MockUp AgregarResponsable Mobile](/assets/MockUpNuevoResponsable.png) 
...
## 10. Pantalla de Inicio  
**Mock-up**  
![MockUp Pantalla Inicio Desktop](/assets/Inicio.png)
  **Mock-up Mobile**  
![MockUp Pantalla Inicio Mobile](/assets/mobilbienvenido.png) 
...
## 11. Pantalla de Detalles de Equipo  
**Mock-up**  
![MockUp Gestion Equipos Desktop](/assets/GestionDeEquipo.png)
  **Mock-up Mobile**  
![MockUp Gestion Equipos Mobile](/assets/GestionEquipoMobile.png) 
**Explicación**  
- **Principios de diseño:** Información agrupada en tarjetas (nombre, estado, responsables).  
- **Elementos de diseño:** Íconos de estado, botones de acción.  
- **Diseño inclusivo:** Texto alternativo en imágenes y colores con suficiente contraste.  
...
**Link del prototipo:**  https://www.figma.com/proto/OSRDXwebVTO7alXvVswuVC/Untitled?node-id=0-1&t=BA3eZDY6GQFIsHNe-1
...
**Link del video:** https://upcedupe-my.sharepoint.com/:v:/g/personal/u202220659_upc_edu_pe/EYqqeiYf6rtGmt44-lKEeUMBnddJKKlWb63o9yCAe5pwbw?e=GWI1TC&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D
...
**Link del miro: https://miro.com/es/jointheteam/OHJ2bHA4TW9PdGtPMFBFTmo2LzFzcjFzL1R1WnRVN1hpSnpCRTlRS09OcjBzOVQ0OFd6MTVJQzFJRWx4YnJGdkIvL2F0WW95b1B1V2xqbjNzMGgwNFZXNGV2dFJSR29PelZMemViNW0zUzJNVDU2WDNOcExoM2NvMmcrS2JDV3RyVmtkMG5hNDA3dVlncnBvRVB2ZXBnPT0hdjE=/**
...
* **Gabriel Braithuaite:** Se encargó de la vista de creación de denuncias, la cual permite al usuario crear y eliminar denuncias.
...
| **Prepared By** | Mamani Marca, Gabriel Cristian |
| **Attendees** | Mamani Marca Gabriel Cristian, Rivera Ticllacuri Omar Harold, Rioja Núñez Franco Diego, Braithuaite Toledo Gabriel Anthony, Montes Maza Augusto Sebastián |
| **Sprint 3 Review Summary** | En esta reunión se planificaron las tareas correspondientes al desarrollo del backend de DenunciaYa. Asimismo, se establecieron fechas límite para cada bounded context con el fin de contar con tiempo para realizar el despliegue y la integración con el frontend. |
| **Sprint 3 Retrospective Summary** | Durante la retrospectiva se identificaron aspectos positivos en el trabajo colaborativo y también oportunidades de mejora relacionadas con la organización interna y la distribución de tareas. Se resaltó la importancia de mantener una comunicación clara, asumir responsabilidades y asegurar la continuidad del avance del proyecto. |
| **Sprint 3 Goal** | Completar la integración y despliegue del backend conectado al frontend, garantizando que los módulos principales (denuncias, mapa, autoridades, comunidad e i18n) operen correctamente en un entorno productivo, y cumplir con los criterios de validación mediante pruebas funcionales y aprobación del Product Owner antes del cierre del sprint. |
| **Sprint 3 Velocity** | 5 story points |
...
| Braithuaite Toledo, Gabriel Anthony | Gaboo04         | C                                     | C                            | C                      | C                                 | L                           |
| Montes Maza, Augusto Sebastián      | Sebastian       | C                                     | C                            | C                      | C                                 | L                           |

# 5.2.3.3.Sprint Backlog 3.
El objetivo principal del Sprint 3 es implementar funcionalidades esenciales del backend relacionadas con la creación, gestión y visualización de denuncias, autenticación, manejo de datos geográficos y procesos internos asociados a comunidades y autoridades.
...
| **Attendees** | Rivera Ticllacuri Omar Harold, Mamani Marca Gabriel Cristian, Rioja Núñez Franco Diego, Braithuaite Toledo Gabriel Anthony, Montes Maza Augusto Sebastián, Montañez Moreno Luis Angel|
...
| Braithuaite Toledo, Gabriel Anthony | Gaboo04         | L                                     | C                            | C                      | C                                 | 
...
|--------------------------|---------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Video de TB1             | Video explicativo de los avances de la entrega TB1     | https://upcedupe-my.sharepoint.com/personal/u202214214_upc_edu_pe/_layouts/15/stream.aspx?id=%2Fpersonal%2Fu202214214%5Fupc%5Fedu%5Fpe%2FDocuments%2FCapitulo%201%20%281%29%2Emp4&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0&ga=1&referrer=StreamWebApp.Web&referrerScenario=AddressBarCopied.view.b0ddff37-271b-4c6d-95b7-4c12d293ff46 |
| Video de TB2             | Video explicativo de los avances de la entrega TB2     | https://youtu.be/Ve_mNNVsj1M                                                                                                                                                                                                                                                                                                                                                                                |
| Video de TP              | Video explicativo de los avances de la entrega TP      | https://youtu.be/RnNm99KYGt0                                                                                                                                                                                                                                                                                                                                                                                |
| Video de TF              | Video explicativo de los avances de la entrega TF      | https://drive.google.com/drive/folders/1L4wkiUNyWWnwlCI0xmGmQTxNOFt4N3wI?usp=sharing                                                                                                                                                                                                                                                                                                                        |
| Video de entrevistas     | Video recopilatorio de todas las entrevistas           | https://upcedupe-my.sharepoint.com/personal/u202214214_upc_edu_pe/_layouts/15/stream.aspx?id=%2Fpersonal%2Fu202214214_upc_edu_pe%2FDocuments%2Fupc-pre-202520-1asi0729-7401-DenunciaYa-needfinding-sprint-1.mp4&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0 |
| Video about the team     | Video explicativo de cada integrante del proyecto      | https://youtu.be/fP2gXCDxE2s                                                                                                                                                                                                                                                                                                                                                                                 |
| Video about the product  | Video explicativo sobre el producto                    | https://youtu.be/-h8-yU7stLA                                                                                                                                                                                                                                                                                                                                                                                |
...
| Frontend     |http://denuncia-ya-frontend.firebaseapp.com     |
| Backend      |  https://denunciayaa.onrender.com/swagger-ui/index.html    |
